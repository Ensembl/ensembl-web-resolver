...
class TestRapidUtils(unittest.TestCase):
    def _assert_rapid_url(self, rapid_path, query_string=""):
        ...
        expected_url = (
            RAPID_ARCHIVE_URL if not rapid_path else f"{RAPID_ARCHIVE_URL}/{rapid_path}"
        )
        if query_string:
    ...
    def test_construct_rapid_archive_url(self):
        ...
        self._assert_rapid_url(
            "Homo_sapiens_GCA_009914755.4/Location/View", "r=1:56873660-58424710"
        )
        self._assert_rapid_url(
            "Homo_sapiens_GCA_009914755.4/Gene/Summary", "r=1:56873660-58424710"
        )
